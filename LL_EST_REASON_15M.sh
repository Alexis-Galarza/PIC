#!/bin/sh
#----------------------------------------------------------------------------------------
# Script para obtener reportes historicos PIC. LL_EST_REASON_15M
# Ejecuta reporte para el dia de ayer
# Ejecucion: ./LL_EST_REASON_15M.sh ConexionBD     (Formato ConexionBD: usr/pass@DB)
#----------------------------------------------------------------------------------------
...
varArchivoOut="LL_EST_REASON_15M_$varFechaArchivo.txt" #--LL_EST_REASON_15M_YYYYMMDD.txt
	#---------------------------------------
	# Hardcode para test
	#varFechaReporte="03-05-2018"
	#varFechaArchivo="20180503"
	#varArchivoOut="LL_EST_REASON_15M_20180503.txt"
	#----------------------------------------
...
from  a001441.AGt_I_SESS_STATE_subhr ASSS
inner join
...
left join
    a001441.agt_i_state_rsn_subhr b
on            
