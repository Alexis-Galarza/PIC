#!/bin/sh
#----------------------------------------------------------------------------------------
# Script para obtener reportes historicos PIC. AB_TOT_15M
# Ejecuta reporte para el dia de ayer
# Ejecucion: ./AB_TOT_15M.sh ConexionBD     (Formato ConexionBD: usr/pass@DB)
#----------------------------------------------------------------------------------------
...
varArchivoOut="AB_TOT_15M_$varFechaArchivo.txt" #--AB_TOT_15M_YYYYMMDD.txt
	#---------------------------------------
	# Hardcode para test
	#varFechaReporte="26-04-2018"
	#varFechaArchivo="20180410"
	#varArchivoOut="AB_TOT_15M_20180410.txt"
	#----------------------------------------
...
from   a001441.AGT_AGENT_QUEUE_subhr agqu
inner join
