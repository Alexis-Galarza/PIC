#!/bin/sh
#----------------------------------------------------------------------------------------
# Script para obtener reportes historicos PIC. VQ_TOT_DIA
# Ejecuta reporte para el dia de ayer
# Ejecucion: ./VQ_TOT_DIA.sh ConexionBD     (Formato ConexionBD: usr/pass@DB)
#----------------------------------------------------------------------------------------
...
varArchivoOut="VQ_TOT_DIA_$varFechaArchivo.txt" #--VQ_TOT_DIA_YYYYMMDD.txt
	#---------------------------------------
	# Hardcode para test
	#varFechaReporte="10-05-2018"
	#varFechaArchivo="20180508"
	#varArchivoOut="VQ_TOT_DIA_20180508.txt"
	#----------------------------------------
...
from a001441.AGT_QUEUE_day queu
inner join
