#!/bin/sh
#----------------------------------------------------------------------------------------
# Script para obtener reportes historicos PIC. VAG_TOT_DIA
# Ejecuta reporte para el dia de ayer
# Ejecucion: ./VAG_TOT_DIA.sh ConexionBD     (Formato ConexionBD: usr/pass@DB)
#----------------------------------------------------------------------------------------
...
varArchivoOut="VAG_TOT_DIA_$varFechaArchivo.txt" #--VAG_TOT_DIA_YYYYMMDD.txt
	#---------------------------------------
	# Hardcode para test
	#varFechaReporte="10-05-2018"
	#varFechaArchivo="20180508"
	#varArchivoOut="VAG_TOT_DIA_20180508.txt"
	#----------------------------------------
...
from a001441.agt_agent_day agt 
inner join
